class GalleryController < ApplicationController
  ...
  def search
    ...
    @flowers_gallery = Store.find_by_sql ["Select * from stores WHERE name like ? or bouquet_type like ? or color like ? or description like ?",keyword,keyword,keyword,keyword]
  end
end
